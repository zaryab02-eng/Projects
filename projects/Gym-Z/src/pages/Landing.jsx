      ...
      <main className="flex-1 flex items-center">
        <div className="max-w-3xl mx-auto px-6 py-16 text-center">
          ...
          <h1 className="font-display text-4xl sm:text-6xl leading-[1.05] mb-5">
            Run your gym like a<br /><span className="text-copper-400">well-loaded barbell.</span>
          </h1>
          <p className="text-ink-500 text-base sm:text-lg max-w-xl mx-auto mb-9">
            Gym-Z tracks every member, every renewal and every expiry so nothing slips —
