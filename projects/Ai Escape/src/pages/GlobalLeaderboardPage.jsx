    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-y-auto">
      ...
      <div className="sticky top-0 z-20 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-[#1a1a1a] px-4 py-3 md:py-4">
        <div className="flex items-center justify-between mb-3 md:mb-4">
          <h1 className="text-xl md:text-2xl font-bold text-[#00ff88]">LEADERBOARD</h1>
          <button
            onClick={() => navigate("/")}
            ...
            <div className="hidden md:block max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                          ...
                          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-xl border-2 border-[#ffd700]/40 p-5 shadow-xl shadow-[#ffd700]/10 hover:shadow-[#ffd700]/20 transition-all duration-300">
                            ...
                            <div className="space-y-1.5 text-xs">
                              <div className="flex items-center justify-between text-white/70">
                                <span>Time</span>
                                <span className="text-[#00ff88] font-semibold">{formatTime(top3Players[0].totalTime)}</span>
                              </div>
                              <div className="flex items-center justify-between text-white/70">
                                <span>Levels</span>
                                <span className="text-white">{top3Players[0].completedLevels}/{top3Players[0].totalLevels}</span>
                              </div>
                              <div className="flex items-center justify-between text-white/70">
                                <span>Wrong</span>
                                <span className="text-white">{top3Players[0].totalWrongAnswers || 0}</span>
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {top3Players[1] && (
                          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-xl border-2 border-[#c0c0c0]/40 p-5 shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="space-y-1.5 text-xs">
                              <div className="flex items-center justify-between text-white/70">
                                <span>Time</span>
                                <span className="text-[#00ff88] font-semibold">{formatTime(top3Players[1].totalTime)}</span>
                              </div>
                              <div className="flex items-center justify-between text-white/70">
                                <span>Levels</span>
                                <span className="text-white">{top3Players[1].completedLevels}/{top3Players[1].totalLevels}</span>
                              </div>
                              <div className="flex items-center justify-between text-white/70">
                                <span>Wrong</span>
                                <span className="text-white">{top3Players[1].totalWrongAnswers || 0}</span>
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {top3Players[2] && (
                          <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-xl border-2 border-[#cd7f32]/40 p-5 shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="space-y-1.5 text-xs">
                              <div className="flex items-center justify-between text-white/70">
                                <span>Time</span>
                                <span className="text-[#00ff88] font-semibold">{formatTime(top3Players[2].totalTime)}</span>
                              </div>
                              <div className="flex items-center justify-between text-white/70">
                                <span>Levels</span>
                                <span className="text-white">{top3Players[2].completedLevels}/{top3Players[2].totalLevels}</span>
                              </div>
                              <div className="flex items-center justify-between text-white/70">
                                <span>Wrong</span>
                                <span className="text-white">{top3Players[2].totalWrongAnswers || 0}</span>
                              </div>
                            </div>
                          </div>
                        )}
                            ...
                            return (
                              <div
                                ...
                                className={`px-5 py-4 hover:bg-[#1f1f1f] transition-colors ${
                                  isCurrentUser ? "bg-[#1a2a1a]/50 border-l-2 border-l-[#00ff88]" : ""
                                }`}
                              >
                                  ...
                                  <div className="flex items-center gap-4 flex-1 min-w-0">
                                    ...
                                    <div className="min-w-0 flex-1">
                                      <div className="text-white font-semibold text-base truncate">
                                        {player.displayName}
                                        {isCurrentUser && (
                                          <span className="text-[#00ff88] ml-2 text-sm">(You)</span>
                                        )}
                                      </div>
                                      <div className="text-white/50 text-xs mt-0.5">
                                        {player.completedLevels}/{player.totalLevels} levels • {player.totalWrongAnswers || 0} wrong
                                      </div>
                                    </div>
                                  </div>
                                  <div className="text-right flex-shrink-0">
                  ...
                  {leaderboardData.topPlayers.length === 0 && (
                    <div className="text-center py-16">
                      <p className="text-white/50 text-base">No players yet. Be the first!</p>
                    </div>
                  )}
                </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="bg-[#1a1a1a] rounded-xl border border-[#2a2a2a] p-5">
                    <h3 className="text-base font-semibold text-white/90 mb-4 tracking-wide">CATEGORY</h3>
                  ...
                  {playerData && (
                    <div className="bg-[#1a1a1a] rounded-xl border border-[#2a2a2a] p-5">
                      <h3 className="text-base font-semibold text-white/90 mb-4 tracking-wide">YOUR STATS</h3>
                      <div className="space-y-4">
                        <div>
                        ...
                        <div className="space-y-3 pt-3 border-t border-[#2a2a2a]">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-white font-semibold text-sm">{formatTime(playerData.totalTime)}</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-white/70">
                              <Target size={16} />
                            ...
                            <span className="text-white font-semibold text-sm">{playerData.completedLevels}/{playerData.totalLevels}</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-white/70">
                              <Users size={16} />
                            ...
                            <span className="text-white font-semibold text-sm">{playerData.totalWrongAnswers || 0}</span>
                          </div>
                        </div>
                        {leaderboardData.totalPlayers > 0 && (
                          <div className="pt-3 border-t border-[#2a2a2a]">
                            <div className="text-white/50 text-xs">
                              {formatPlayerCount(leaderboardData.totalPlayers)} total players
                            </div>
                          </div>
                        )}
                      </div>
                  ...
                  {playerRank && playerRank > 20 && playerData && (
                    <div className="bg-gradient-to-br from-[#1a2a1a] to-[#1a1a1a] rounded-xl border border-[#00ff88]/30 p-5 shadow-lg shadow-[#00ff88]/5">
                      <h3 className="text-base font-semibold text-[#00ff88] mb-3 tracking-wide">YOUR RANK</h3>
                      <div className="space-y-3">
                        <div>
                          <div className="text-[#00ff88] font-bold text-3xl mb-1">#{playerRank}</div>
                        ...
                        <div className="pt-3 border-t border-[#00ff88]/20">
                          <div className="text-white/70 text-xs mb-1">Total Time</div>
