        ...
        <div className="card max-w-2xl">
          <div className="text-center">
            <AlertTriangle
              ...
              size={64}
            />
            <h2 className="text-4xl font-bold text-cyber-danger mb-4">
              DISQUALIFIED
            </h2>
      ...
      <div className="min-h-screen p-4 md:p-8 cyber-grid">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-5xl font-bold text-cyber-accent glow-text mb-4">
              GAME COMPLETE
            </h1>
            <p className="text-xl text-white">Thank you for playing!</p>
          </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {allLevelsCompleted ? (
          <div className="card text-center py-12">
            <h2 className="text-4xl font-bold text-cyber-accent glow-text mb-4">
              🎉 ALL LEVELS COMPLETE! 🎉
            </h2>
        ...
        {/* Warnings */}
        {player?.warnings > 0 && (
          <div className="mt-6 bg-cyber-warning bg-opacity-20 p-4 rounded-lg border border-cyber-warning">
            <p className="text-cyber-warning text-center font-bold">
