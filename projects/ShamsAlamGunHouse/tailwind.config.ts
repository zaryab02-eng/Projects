...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "brass-gradient":
          "linear-gradient(135deg, #D6B37B 0%, #B08D57 45%, #8A6B3E 100%)",
        vignette:
          "radial-gradient(120% 120% at 50% 0%, rgba(11,12,14,0) 0%, rgba(11,12,14,0.9) 100%)",
      },
      boxShadow: {
        brass:
          "0 0 0 1px rgba(176,141,87,0.35), 0 8px 30px -8px rgba(176,141,87,0.25)",
